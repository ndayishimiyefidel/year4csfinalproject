...
import 'add_pupils.dart';

class TeacherManager extends StatefulWidget {
  const TeacherManager({Key? key}) : super(key: key);

  @override
  State<TeacherManager> createState() => _TeacherManagerState();
}

class _TeacherManagerState extends State<TeacherManager> {
  @override
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return TeacherScreen(currentUser: userId);
            }));
          },
        ),
      ),
