...
class PTodayAttendance extends StatefulWidget {
  @override
  _PTodayAttendanceState createState() => _PTodayAttendanceState();
}
...
class _PTodayAttendanceState extends State<PTodayAttendance> {
  ...
  void initState() {
    ...
    databaseService.getTodayPupilsAttendance(today, userId).then((value) async {
      setState(() {
